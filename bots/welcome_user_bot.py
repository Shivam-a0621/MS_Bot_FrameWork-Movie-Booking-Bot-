...
from data.welcome_user_state import WelcomeUserState
...
class WelcomeUserBot(ActivityHandler):
    ...
    async def __send_intro_card(self, turn_context: TurnContext):
        card = HeroCard(
            ...
            images=[CardImage(url="https://pbs.twimg.com/profile_images/1629549340023988224/uiCt5NBY_400x400.jpg")],
            buttons=[
                CardAction(
                ...
                CardAction(
                    ...
                    value="https://x.com/itsbhardwaj21",
                ),
